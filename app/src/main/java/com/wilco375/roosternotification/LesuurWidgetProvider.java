    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i=0; i<N; i++) {
            ...
            if(!(subject.equals("") && location.equals("")) && !cancelled){
                if(!timeslot.equals("0") && !timeslot.equals("")) views.setTextViewText(R.id.app_widget_lesuur_title, timeslot + ": " + subject);
                ...
                if(!timeslot.equals("0") && !timeslot.equals("")) spannableString1 = new SpannableString(timeslot + ": " +subject);
