...
public class LesuurWidgetProvider extends AppWidgetProvider{
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i=0; i<N; i++) {
            ...
            uur = AlarmReceiver.lesuur(context,sp);
            ...
            }else if(sp.getBoolean(string+"2",false)){
                SpannableString spannableString1 = new SpannableString(uur + ": " +subject);
                SpannableString spannableString2 = new SpannableString(classroom);
